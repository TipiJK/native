	...
	<table>
		<thead>	
			<tr>
				...
				<th colspan="2" class="oikealle"><a id="takaisin" href="listaaasiakkaat.jsp">Takaisin listaukseen</a></th>
			</tr>		
			<tr>
				<th>Etunimi</th>
				<th>Sukunimi</th>
		...
		<tbody>
			<tr>
				...
				<td><input type="submit" id="tallenna" value="Tallenna muutokset" onclick="vieTiedot()"></td>
			</tr>
		</tbody>
	</table>
		<input type="hidden" name="asiakas_id" id="asiakas_id"> <!-- pitää asiakas_id:n tallessa lomaketta varten, mutta poissa näkyviltä -->
</form>
</body>
<script>
...
function vieTiedot(){	
	...
	if(document.getElementById("etunimi").value.length<2){
		...
		ilmo="Puhelinnumero liian pitkä!";	
